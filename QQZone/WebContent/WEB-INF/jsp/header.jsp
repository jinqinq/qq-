  ...
  <div class="head_nav">
    ...
    <div class="w960">
      <ul>
        ...
        <li><a href="<%=request.getContextPath()%>/showMessages?receiveid=${host.userid }&currentPage=1">留言板</a></li>
        <li><a href="<%=path%>/feelmy?userid=${host.userid }&currentPage=1"">说说</a></li>
        <li><a href="<%=request.getContextPath()%>/showFriends" >好友</a></li>
      </ul>
      <div class="head-avatar">
	  <a href="<%=path %>/jsp/updateheadpic.jsp" target="iframepage"><img src="static/headpic/${host.headpic }" alt=""/></a>
      </div>
    </div>
  </div>
</div>
