...
<body>
				<div class="inner">
					<div class="hd">
						<h3>基本资料
						<a href="<%=path%>/update" target="iframepage" class="comfirm">修改</a>
						</h3>
					</div>
					<div class="infos">
					<img src="static/headpic/${host.headpic}" width="80" height="80"/><br>
					    QQ号码：${host.qq}<br>
						昵称：${host.username}<br> 
					 	性别：
